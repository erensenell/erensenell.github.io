...
const reloadUser = async (data) => {
  ...
  <a class="discord" href="https://discord.gg/aVrZVkHYam" target="_blank">Discord</a>`);
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + 'https://api.github.com/users/erensenell/repos');
...
function loadIcons() {
  ...
  $('location > a').text('Samsun, Türkiye');
  ...
  const socials = [
    {
      ...
      href: 'https://instagram.com/yazilimkolonigi',
      tippy: 'Instagram'
    },
    {
      ...
      href: 'mailto:seneleren798@gmail.com',
      tippy: 'E-Mail'
    },
    {
      ...
      href: `https://discord.gg/aVrZVkHYam`,
      tippy: 'Discord'
    },
    {
      ...
      href: 'https://github.com/erensenell',
      tippy: 'GitHub'
    }
  ];
